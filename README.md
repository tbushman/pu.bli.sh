...
Use CartoDB to update the content with your own map. Available fields are: 'name', 'title', 'place', 'description', 'pic1', 'pic2', 'pic3', 'pic4', 'pic5', 'datebegin', 'dateend', and 'link'(URL).
